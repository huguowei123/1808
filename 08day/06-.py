...
def GameResult(GameResult):
    # 游戏结果背景Surface对象
    GameResultBackground = pygame.image.load('/home/huiguowei/桌面/1808/07day/images/enemy0.png"').convert()
    # 游戏结果引导
    ResultHint = pygame.image.load('"/home/huiguowei/桌面/1808/07day/images/hero.gif"
').convert_alpha()
    # 游戏结果Font对象
    GameResultFont = pygame.font.Font('"/home/huiguowei/桌面/1808/07day/images/hero1.gif"
', 100)
    # 重新开始按钮
    ReStartButton = pygame.image.load('"/home/huiguowei/桌面/1808/07day/images/hero1.gif"
').convert_alpha()
    # 重新开始Hover按钮
    ReStartButtonHover = pygame.image.load('"/home/huiguowei/桌面/1808/07day/images/hero1.gif"
').convert_alpha()
